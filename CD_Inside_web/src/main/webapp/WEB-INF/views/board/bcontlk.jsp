       ...
       data:{
		...
		success : function(data) {//통신이 성공적으로 이루어 졌을때 받을 함수
			...
			divIn += 	'<div class="media-heading">'
				+				'<div id="container">'
				+					'<div>'
				+						'<a class="commId hidden" href="' + '/cd/gallog/gallog_home.do?userId=' + data.userId + '">' + data.userId + '</a>&nbsp;'
				+  							'<div class="dropdown">'
				+ 								'<button class="text-center" id="dLabel" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"' 
				+	   							'style="border:none; padding:0; background:none;">'
				+	  								'<span class="cu" >  ' + data.userId + '</span>'
				+	  							'</button>' 
				+	  							'<ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">'
				+									'<li><button type="button" style="border:none; padding:0; background:none;" value="' + data.userId + '" class="dropdown-item" id="gallog" onclick="location.href=\'' + '/cd/gallog/gallog_home.do?userId=' + data.userId + '\'">　 Gallog</button></li>'
				+	    							'<li><button type="button" style="border:none; padding:0; background:none;" value="' + data.userId + '" class="dropdown-item reId" onclick="location.href=\'' + '/cd/msg/send.do?reId=' + data.userId + '\'">　 쪽지 보내기</button><li>'  
		            ...
		            $.each(data.list, function(key, value){
		            	var divIn = "";
		            		divIn += 	'<div class="media-heading">'
			    				+				'<div id="container">'
			    				+					'<div>'
			    				+						'<a class="commId hidden" href="' + '/cd/gallog/gallog_home.do?userId=' + value.userId + '">' + value.userId + '</a>&nbsp;'
								+  							'<div class="dropdown">'
								+ 								'<button class="text-center" id="dLabel" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"' 
								+	   							'style="border:none; padding:0; background:none;">'
								+	  								'<span class="cu" >  ' + value.userId + '</span>'
								+	  							'</button>' 
								+	  							'<ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">'
								+									'<li><button type="button" style="border:none; padding:0; background:none;" value="' + value.userId + '" class="dropdown-item" id="gallog" onclick="location.href=\'' + '/cd/gallog/gallog_home.do?userId=' + value.userId + '\'">　 Gallog</button></li>'
								+	    							'<li><button type="button" style="border:none; padding:0; background:none;" value="' + value.userId + '" class="dropdown-item reId" onclick="location.href=\'' + '/cd/msg/send.do?reId=' + value.userId + '\'">　 쪽지 보내기</button><li>'  
								+	    							'<li><a class="dropdown-item" href="/cd/mypage/user_update.do">마이페이지</a><li>'
								+								'</ul>'
								+ 									'</a>&nbsp;'
