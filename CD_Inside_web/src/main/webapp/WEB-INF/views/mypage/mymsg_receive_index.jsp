	...
	<!--// 마이페이지 공통------------------------------------------------------->
		...
		<div class="container" style="padding-top:3%">
	    	<ul class="nav nav-tabs">
				...
				<li role="presentation"><a style=" color: #BE81F7" href="sendIndex.do">보낸쪽지함</a></li>
			</ul>		
		</div>
					...
					<c:when test="${list.size()>0}">
						<c:forEach var="msgVo" items="${list}">
							<tr>
								...
								<td class="text-center" onclick='event.cancelBubble=true;'><c:out value="${msgVo.userId}"></c:out></td>																															
								<td style="display: none" class="text-center"><c:out value="${msgVo.msgRecvId}"></c:out></td>																															
								...
								<td class="text-center" onclick='event.cancelBubble=true;'><c:out value="${msgVo.msgReadYn}"></c:out></td>
