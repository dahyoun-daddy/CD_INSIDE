...
public class BoardCtrl {
	...
	@ResponseBody
	public String do_hitComment(BoardVO boardVO)
	...
	public String do_retrieve(@ModelAttribute BoardVO invo, Model model, HttpServletRequest req)
	...
	public String do_cateret(@ModelAttribute BoardVO invo, Model model, HttpServletRequest req)
			throws EmptyResultDataAccessException, ClassNotFoundException, SQLException {
	...
	public String do_cateretLK(@ModelAttribute BoardVO invo, Model model, HttpServletRequest req)
			throws EmptyResultDataAccessException, ClassNotFoundException, SQLException {
...
//			}
	...
	public String get(@ModelAttribute BoardVO invo, Model model, HttpServletRequest req)
			throws EmptyResultDataAccessException, ClassNotFoundException, SQLException {
...
//		model.addAttribute("userid", invo.getUserId());
	...
	public String getlk(@ModelAttribute BoardVO invo, Model model, HttpServletRequest req)
			throws EmptyResultDataAccessException, ClassNotFoundException, SQLException {
...
//			model.addAttribute("userid", invo.getUserId());
	...
	public String write(@ModelAttribute BoardVO invo, Model model, HttpServletRequest req)
			throws EmptyResultDataAccessException, ClassNotFoundException, SQLException {
	...
	public String writeLK(@ModelAttribute BoardVO invo, Model model, HttpServletRequest req)
			throws EmptyResultDataAccessException, ClassNotFoundException, SQLException {
	...
	@RequestMapping(value = "/addSY.do", method = RequestMethod.POST, produces = "application/json;charset=utf8")
	@ResponseBody
	public String addSY(@ModelAttribute BoardVO invo, HttpServletRequest req, Model model)
			throws EmptyResultDataAccessException, ClassNotFoundException, SQLException {
...
//		}
	...
	@RequestMapping(value = "/addLK.do", method = RequestMethod.POST, produces = "application/json;charset=utf8")
	@ResponseBody
	public String addLK(@ModelAttribute BoardVO invo, HttpServletRequest req, Model model)
			throws EmptyResultDataAccessException, ClassNotFoundException, SQLException {
...
//		}
	...
	public String multiplePhotoUpload(HttpServletRequest request) {
		...
		try {
			...
			// 파일 기본경로 _ 상세경로 이 방법 쓰기 @Value("classpath*:test/*.xml") private Resource[]
			// resources;
	...
	@ResponseBody
	public String update(@ModelAttribute BoardVO invo, HttpServletRequest req, Model model)
			throws EmptyResultDataAccessException, ClassNotFoundException, SQLException {
	...
	@ResponseBody
	public String delete(BoardVO invo, Model model)
			throws EmptyResultDataAccessException, ClassNotFoundException, SQLException {
	...
	@ResponseBody
	public String cnt(BoardVO invo, Model model)
			throws EmptyResultDataAccessException, ClassNotFoundException, SQLException {
	...
	@ResponseBody
	public String addreplyComment(CommentVO commentVO)
			throws EmptyResultDataAccessException, ClassNotFoundException, SQLException, JsonProcessingException {
	...
	@ResponseBody
	public String do_hitComment(CommentVO commentVO)
			throws EmptyResultDataAccessException, ClassNotFoundException, SQLException, JsonProcessingException {
		log.info("commentVO:" + commentVO);
	...
	@ResponseBody
	public String getUserList(CommentVO invo)
			throws EmptyResultDataAccessException, ClassNotFoundException, SQLException, JsonProcessingException {
	...
	@ResponseBody
	public String getPagingList(CommentVO invo)
			throws EmptyResultDataAccessException, ClassNotFoundException, SQLException, JsonProcessingException {
	...
	@ResponseBody
	public String scroll_reply_retrieve(CommentVO invo)
			throws EmptyResultDataAccessException, ClassNotFoundException, SQLException, JsonProcessingException {
